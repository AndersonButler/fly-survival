...
my_results = plot(NULL, xaxt='n', yaxt='n', bty='n', ylab='', xlab='', xlim=c(0, 100), ylim=c(0, 100), xaxs = 'i', yaxs = 'i')
my_results = my_results + for (i in seq_along(summ)) {
            text(0, 100 - i*4, pos=4, summ[i], cex = 0.5, family='mono')
            }
...
df.final2$Treatment = factor(df.final2$Genotype, levels = c("MitoGFP/+ ; TubGal80ts/D42-Gal4","MitoGFP/+ ; D42Gal4/+","G298S/MitoGFP ; TubGal80ts/D42-Gal4"))
